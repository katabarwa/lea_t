...
import CD from '@/assets/icons/disc-spin.gif'
import TV from '@/assets/icons/gif_tv_dvd_4.gif'
import LEA from '@/assets/icons/Lea_3D_icon.png'
import Photo from '@/assets/icons/photo-album.png'
import ART from '@/assets/icons/render_000.png'
